...
class PermissionMatrixTests(unittest.TestCase):
    ...
    SPEC_CLASSIFICATIONS = {
        ...
        "admin": (
            "settings_page", "benchmark_page", "api_benchmark_suites",
            "api_benchmark_papers", "api_benchmark_create_draft",
            "api_benchmark_suite", "api_benchmark_generate_cases",
            "api_benchmark_review_case", "api_benchmark_review_all",
